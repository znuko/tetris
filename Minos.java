    ...
    switch (type){
      ...
      case "J":
        for (int angle = 0; angle < Mino.angles; angle++){
          values[angle][0] = new int[]{0, 0, 1, 0};
          values[angle][1] = new int[]{0, 0, 1, 0};
          values[angle][2] = new int[]{0, 1, 1, 0};
      ...
      case "S":
        for (int angle = 0; angle < Mino.angles; angle++){
          values[angle][0] = new int[]{0, 1, 1, 0};
          values[angle][1] = new int[]{1, 1, 0, 0};
          values[angle][2] = new int[]{0, 0, 0, 0};
          values[angle][3] = new int[]{0, 0, 0, 0};
        }
        break;
      ...
      case "T":
        for (int angle = 0; angle < Mino.angles; angle++){
          values[angle][0] = new int[]{1, 1, 1, 0};
          values[angle][1] = new int[]{0, 1, 0, 0};
          values[angle][2] = new int[]{0, 0, 0, 0};
          values[angle][3] = new int[]{0, 0, 0, 0};
        }
        break;
      ...
      case "Z":
        for (int angle = 0; angle < Mino.angles; angle++){
          values[angle][0] = new int[]{1, 1, 0, 0};
          values[angle][1] = new int[]{0, 1, 1, 0};
          values[angle][2] = new int[]{0, 0, 0, 0};
          values[angle][3] = new int[]{0, 0, 0, 0};
        }
